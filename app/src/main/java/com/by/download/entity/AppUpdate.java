package com.by.download.entity;
...
//        private int updateContentTitle = R.string.update_content_lb;
         ...
         * 默认的更新颜色
         */
        private int updateColor = R.color.white;

        /**
         * 默认的取消更新文本颜色
         */
        private int updateCancelColor = R.color.color_black;

        /**
         * 默认的更新进度条颜色
         */
        private int updateProgressColor = R.color.gradient_start_color;
         ...
         * 更新对话框的id
         */
        private int updateResourceId = R.layout.dialog_upgrade;
